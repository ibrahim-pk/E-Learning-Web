...
export default class EditCourse extends Component{
    ...
    componentDidMount() {
        ...
        axios.get('https://pedu-ibrahimecste.vercel.app/course?id='+this.props.match.params.id)
            .then(response => {
        ...
        axios.get('https://pedu-ibrahimecste.vercel.app/categories/')
        .then(response => {
        ...
        onSubmit = (e) => {
            ...
            axios.put('https://pedu-ibrahimecste.vercel.app/course?id='+this.state.todos._id, {courseName, courseDescription, category, instructor})
            .then((result) => {
