...
export default class CreateEnroll extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://pedu-ibrahimecste.vercel.app/courses/")
      .then(response => {
    ...
    axios
      .get("https://pedu-ibrahimecste.vercel.app/users/")
      .then(response => {
  ...
  onSubmit(e) {
    ...
    axios.post("https://pedu-ibrahimecste.vercel.app/enroll/add/", newTodo).then(result => {
