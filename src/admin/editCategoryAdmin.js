...
export default class CatEdit extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://pedu-ibrahimecste.vercel.app/category?id=" + this.props.match.params.id)
      .then(response => {
  ...
  onSubmit = e => {
    ...
    axios
      .put("https://pedu-ibrahimecste.vercel.app/category?id=" + this.props.match.params.id, {
        no,
        categoryName
      })
      .then(result => {
