...
export default class UserEdit extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://pedu-ibrahimecste.vercel.app/user?id='+this.props.match.params.id)
            .then(response => {
            ...
            axios.get('https://pedu-ibrahimecste.vercel.app/showroles/')
            .then(response => {
    ...
    delete(id){
      console.log(id);
      axios.delete('https://pedu-ibrahimecste.vercel.app/user?id='+this.props.match.params.id)
        .then((result) => {
    ...
    onSubmit = (e) => {
        ...
        axios.put('https://pedu-ibrahimecste.vercel.app/user?id='+this.props.match.params.id, {first_name, last_name, email, password, role})
        .then((result) => {
          this.props.history.push("/allusers/")
        });
    }
